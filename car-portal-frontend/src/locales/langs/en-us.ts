const local: App.I18n.Schema = {
  ...
  route: {
    ...
    portal_case: 'Case Management',
    portal_home: 'Home Config',
    portal_mapping: 'User Mapping',
    exception: 'Exception',
    exception_403: '403',
    exception_404: '404',
    exception_500: '500',
  ...
  page: {
    login: {
      common: {
        ...
        subTitle: 'Provides developers with a complete Car Portal management solution',
    ...
    about: {
      title: 'About',
      introduction: `Car Portal is a modern enterprise-level multi-tenant management system, providing developers with a complete enterprise management solution.`,
      projectInfo: {
        title: 'Project Info',
        version: 'Version',
